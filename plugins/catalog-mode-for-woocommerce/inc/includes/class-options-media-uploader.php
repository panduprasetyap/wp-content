...
class WCPCM_Options_Framework_Media_Uploader {
	...
	public function init() {
		add_action( 'admin_enqueue_scripts', array( $this, 'wcpcm_optionsframework_media_scripts' ) );
	}
	...
	static function wcpcm_optionsframework_uploader( $_id, $_value, $_desc = '', $_name = '' ) {
	 ...
	 */
	function wcpcm_optionsframework_media_scripts( $hook ) {

		$menu = WCPCM_Options_Framework_Admin::menu_settings();
		...
		wp_register_script( 'of-media-uploader', WCPCM_OPTIONS_FRAMEWORK_DIRECTORY .'js/media-uploader.js', array( 'jquery' ), WCPCM_Options_Framework::VERSION );
		wp_enqueue_script( 'of-media-uploader' );
		wp_localize_script( 'of-media-uploader', 'wcpcm_optionsframework_l10n', array(
